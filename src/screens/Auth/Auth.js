...
import {View , Text , Button  , StyleSheet ,ImageBackground , Dimensions , KeyboardAvoidingView , Keyboard , TouchableWithoutFeedback , ActivityIndicator} from 'react-native';
...
class AuthScreen extends Component{
    ...
    // to handle auto sigin in functionality , if we chek we have a token
    // after this we set the token and redriect the user
